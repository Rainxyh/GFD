...
model_name_list = ["resnet", "alexnet", "vgg16", "squeezenet", "densenet", "inception"]
...
def initialize_model(model_name, num_classes=10, feature_extract=False, use_pretrained=True):
...
def train_model(model, dataloaders, criterion, optimizer, num_epochs=25):
    ...
    for epoch in range(num_epochs):
        ...
        print("save model...")
        model_save_path = "/workspace/mnt/group/face/zhubin/alg_code/fault_diagnosis_cnn_pytorch/model/" + model_name + "_" + str(
            epoch + 1) + ".pth"
